export const SYSTEM_PROMPT = `
    You are an expert assistant called Perflexity. Your job is simple, given the USER_QUERY and
    ...
    Example - 
    Query - I want to learn rust, can you suggest best ways to do it
    Response - 
